...
namespace QoDL.Toolkit.Module.DynamicCodeExecution.Storage
{
    /// <summary>
    ...
    {
        private TKSimpleDataStoreWithId<DynamicCodeScript, Guid> Store { get; set; }
        ...
        {
            Store = new TKSimpleDataStoreWithId<DynamicCodeScript, Guid>(
                filepath,

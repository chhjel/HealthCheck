...
using QoDL.Toolkit.Module.DynamicCodeExecution.Exceptions;
...
internal class RuntimeCodeTester
{
    ...
    {{
        ...
        public static System.Collections.Generic.List<QoDL.Toolkit.Module.DynamicCodeExecution.Models.DiffModel> Diffs {{ get; set; }}

        public static void Init(System.Collections.Generic.List<QoDL.Toolkit.Module.DynamicCodeExecution.Models.DataDump> dumpList, 
                                System.Collections.Generic.List<QoDL.Toolkit.Module.DynamicCodeExecution.Models.DiffModel> diffList) 
        {{
            Dumps = dumpList;
            Diffs = diffList;
        }}
    ...
    {{
        ...
        {{ QoDL.Toolkit.Module.DynamicCodeExecution.Util.DumpHelper.SaveDumps(DCEInternalHelpers.Dumps, pathOrFilename, includeTitle, includeType); }}
    }}
    ...
    {{
        ...
        {{ return QoDL.Toolkit.Module.DynamicCodeExecution.Util.DumpHelper.Dump<T>(obj, DCEInternalHelpers.Dumps, title, display, ignoreErrors); }}
		
		public static T Dump<T>(this T obj, string title = null, bool display = true, params Newtonsoft.Json.JsonConverter[] converters)
        {{ return QoDL.Toolkit.Module.DynamicCodeExecution.Util.DumpHelper.Dump<T>(obj, DCEInternalHelpers.Dumps, title, display, converters); }}
	
		public static T Dump<T>(this T obj, System.Func<T, string> dumpConverter, string title = null, bool display = true)
        {{ return QoDL.Toolkit.Module.DynamicCodeExecution.Util.DumpHelper.Dump<T>(obj, DCEInternalHelpers.Dumps, dumpConverter, title, display); }}

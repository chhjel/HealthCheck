...
public class TKControlledEndpointAttribute : ActionFilterAttribute
{
    ...
    protected virtual EndpointControlHandledRequestResult AllowExecute(ActionExecutingContext filterContext)
    {
        ...
        {
            filterContext.HttpContext.Items[EndpointControlUtils.RequestItemKey_Allowed] = allowed;

            if (ManuallyCounted)
            {
                filterContext.HttpContext.Items[EndpointControlUtils.RequestItemKey_RequestData] = requestData;
            }
        }
    ...
    /// </summary>
    protected virtual IActionResult CreateBlockedResult(ActionExecutingContext filterContext, EndpointControlHandledRequestResult handledResult)
    {
    ...
    protected virtual EndpointControlEndpointRequestData GetEndpointRequestData(ActionExecutingContext filterContext)
    {
        ...
        var data = new EndpointControlEndpointRequestData
        {
            ...
            UserLocationId = RequestUtils.GetIPAddress(filterContext?.HttpContext),

...
namespace QoDL.Toolkit.Module.EndpointControl.Models
{
    ...
    public class EndpointControlRule
    {
        ...
        /// </summary>
        public List<TKEndpointControlConditionData> Conditions { get; set; } = new List<TKEndpointControlConditionData>();
        ...
        public bool ShouldBlockRequest(EndpointControlEndpointRequestData data,
            ...
            Func<string, ITKEndpointControlRuleCondition> conditionFactory)
        {
        ...
        private bool AllConditionsMatch(Func<string, ITKEndpointControlRuleCondition> conditionFactory, EndpointControlEndpointRequestData data)
        {
            ...
            foreach (var condition in Conditions)
            {
                ...
                {
                    object parameters = conditionDef.CustomPropertiesModelType == null ? null : TKValueConversionUtils.ConvertInputModel(conditionDef.CustomPropertiesModelType, condition.Parameters);

...
/// </summary>
public interface ITKDataExportStream
{
    /// <summary>
    /// Name of the stream.
    /// </summary>
    ...
    /// </summary>
    TKMemberFilterRecursive IncludedMemberFilter { get; }
    ...
    /// </summary>
    IEnumerable<ITKDataExportValueFormatter> ValueFormatters { get; }
    ...
    Task<EnumerableResult> GetEnumerableAsync(TKDataExportFilterData filter);
    ...
    /// </summary>
    List<TKBackendInputConfig> PostprocessCustomParameterDefinitions(List<TKBackendInputConfig> customParameterDefinitions);

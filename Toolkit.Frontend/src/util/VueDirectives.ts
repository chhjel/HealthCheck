    ...
    return [
        (() => {
            ...
            const setHeight = (el: HTMLElement) => {
                const targetElements: Array<HTMLElement> = (<any>el)._tk.targetElements;
            ...
            return {
                ...
                directive: {
                    mounted: (el: HTMLElement, binding, vnode) => {
                        ...
                        (<any>el)._tk = {};
                        (<any>el)._tk.targetElements = targetElements;
                        (<any>el)._tk.observer = observer
                        
                        setHeight(el);
                    },
                    beforeUnmount: (el: HTMLElement) => {
                        const observer: ResizeObserver = (<any>el)._tk.observer;
                        observer.disconnect();
                    }
                }
            };

<!-- src/components/ToolkitPageComponent.vue -->
<template>
    <div>
...
import ToolkitProfileDialogComponent from '@components/profile/ToolkitProfileDialogComponent.vue';
...
import { ModuleSpecificConfig } from "./ToolkitPageComponent.vue.models";
...
@Options({
    components: {
        ...
        ToolkitProfileDialogComponent,
        AccessTokenKillswitchDialog
    }
})
export default class ToolkitPageComponent extends Vue {
    @Prop({ required: true })
    ...
    {
        var options = (<any>window).toolkitModuleOptions;

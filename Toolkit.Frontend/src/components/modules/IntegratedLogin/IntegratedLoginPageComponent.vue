...
<script lang="ts">
import { TKLoginTwoFactorCodeInputMode } from "@generated/Enums/WebUI/TKLoginTwoFactorCodeInputMode";
import { TKLoginWebAuthnMode } from "@generated/Enums/WebUI/TKLoginWebAuthnMode";
...
import IntegratedLoginService, { TKIntegratedLoginRequest2FACodeRequest, TKIntegratedLoginResult } from '@services/IntegratedLoginService';
...
export default class IntegratedLoginPageComponent extends Vue {
    ...
    webAuthnLoginPayload: TKVerifyWebAuthnAssertionModel | null = null;
    ...
    get webAuthnMode(): TKLoginWebAuthnMode {
        return this.globalOptions.IntegratedLoginWebAuthnMode;
    }
    get requireWebAuthn(): boolean
    {
        return this.webAuthnMode == TKLoginWebAuthnMode.Required;
    }
    get showWebAuthnInput(): boolean
    {
        return this.webAuthnMode != TKLoginWebAuthnMode.Off;
    }

    get twoFactorCodeInputMode(): TKLoginTwoFactorCodeInputMode {
        return this.globalOptions.IntegratedLoginTwoFactorCodeInputMode;
    }
    get requireTwoFactorCode(): boolean
    {
        return this.twoFactorCodeInputMode == TKLoginTwoFactorCodeInputMode.Required;
    }
    get showTwoFactorCodeInput(): boolean
    {
        return this.twoFactorCodeInputMode != TKLoginTwoFactorCodeInputMode.Off;
    }
    ...
    login(): void
    {
        ...
        let payload: TKIntegratedLoginRequest = {
            Username: this.username,
            Password: this.password,
            TwoFactorCode: this.twoFactorCode,
            WebAuthnPayload: (this.webAuthnLoginPayload || {}) as TKVerifyWebAuthnAssertionModel
        };
    ...
    request2FACode(): void {
        ...
        let payload: TKIntegratedLoginRequest2FACodeRequest = {
            Username: this.username
        };

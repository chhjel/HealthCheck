...
`;
	...
	InputComponent_value: string = "Some string here 4";
	...
	BackendInputComponent_config: TKBackendInputConfig = this.createBackendInputConfig('Int32');
	...
	ParameterInputAnyJsonComponent_type: string = "Some string here 9";
	ParameterInputAnyJsonComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputPickReferenceComponent_value: string = "Some string here 10";
	ParameterInputPickReferenceComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeBooleanComponent_value: boolean = true;
	ParameterInputTypeBooleanComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeDateTimeComponent_value: string = "2021-08-14T22:22:00";
	ParameterInputTypeDateTimeComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeDecimalComponent_value: string = "12.34";
	ParameterInputTypeDecimalComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeDoubleComponent_value: string = "23.45";
	ParameterInputTypeDoubleComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeEnumComponent_value: string = "Some string here 15";
	ParameterInputTypeEnumComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeFlaggedEnumComponent_value: string = "Some string here 16";
	ParameterInputTypeFlaggedEnumComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeGenericListComponent_name: string = "Some string here 17";
	ParameterInputTypeGenericListComponent_value: string = "Some string here 18";
	ParameterInputTypeGenericListComponent_type: string = "Some string here 19";
	ParameterInputTypeGenericListComponent_listType: string = "Int32";
	ParameterInputTypeGenericListComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeGuidComponent_value: string = "Some string here 21";
	ParameterInputTypeGuidComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeHttpPostedFileBaseComponent_value: string = "Some string here 22";
	ParameterInputTypeHttpPostedFileBaseComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeInt32Component_value: string = "3456";
	ParameterInputTypeInt32Component_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeInt64Component_value: string = "45678901231234";
	ParameterInputTypeInt64Component_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeSingleComponent_value: string = "56.78";
	ParameterInputTypeSingleComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeStringComponent_value: string = "Some string here 26";
	ParameterInputTypeStringComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
	ParameterInputTypeTimeSpanComponent_value: string = "Some string here 27";
	ParameterInputTypeTimeSpanComponent_config: TKBackendInputConfig = this.createBackendInputConfig();
    ...
    createBackendInputConfig(type: string = 'type'): TKBackendInputConfig {
        return {
            Type: type,
            Id: 'id',
            Name: 'Name',

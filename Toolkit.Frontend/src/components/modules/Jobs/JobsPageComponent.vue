...
export default class JobsPageComponent extends Vue {
    ...
    selectedJob: TKJobDefinitionWithSourceViewModel | null = null;
    ...
    onJobDefinitionsRetrieved(data: Array<TKJobDefinitionWithSourceViewModel> | null): void {
    ...
    setActiveJob(job: TKJobDefinitionWithSourceViewModel | string | null, updateUrl: boolean = true): void {
        if (this.isLoading) {
            return;
        }
    ...
    get selectedJobStatus(): TKJobStatusViewModel | null {

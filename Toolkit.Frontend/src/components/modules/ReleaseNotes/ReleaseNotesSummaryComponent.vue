...
import { TKReleaseNoteChangeViewModel } from "@generated/Models/Core/TKReleaseNoteChangeViewModel";
...
export default class ReleaseNotesSummaryComponent extends Vue {
    @Prop()
    config!: TKReleaseNotesViewModel;

    id: string = IdUtils.generateId();
    visible: boolean = false;
    hasNewChanges: boolean = false;
    hadNewChangesOnMounted: boolean = false;
    lastViewedVersionStorageKey: string = '__TK_ReleaseNotes_LastViewedVersion';
    visibilityStorageKey: string = '__TK_ReleaseNotes_Visibility';
    ...
    //  GETTERS  //
    //////////////
    get includedChanges(): Array<TKReleaseNoteChangeViewModel> {

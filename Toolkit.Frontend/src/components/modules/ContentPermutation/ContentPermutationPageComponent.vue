...
import { TKContentPermutationTypeViewModel } from "@generated/Models/Core/TKContentPermutationTypeViewModel";
import { TKContentPermutationChoiceViewModel } from "@generated/Models/Core/TKContentPermutationChoiceViewModel";
import StringUtils from "@util/StringUtils";
import { TKPermutatedContentItemViewModel } from "@generated/Models/Core/TKPermutatedContentItemViewModel";
...
export default class ContentPermutationPageComponent extends Vue {
    ...
    permutationTypes: TKGetPermutationTypesViewModel = {
        Types: []
    };
    currentType: TKContentPermutationTypeViewModel | null = null;
    currentPermutation: TKContentPermutationChoiceViewModel | null = null;
    exampleContent: TKGetPermutatedContentViewModel | null = null;
    filter: object = {};

    filterInputs: Array<TKBackendInputConfig> = [];
    ...
    onPermutationTypesRetrieved(data: TKGetPermutationTypesViewModel): void {
    ...
    loadContentFor(typeId: string, choiceId: number): void {
        const payload: TKGetPermutatedContentRequest = {
    ...
    onContentLoadedFor(typeId: string, choiceId: number, data: TKGetPermutatedContentViewModel): void {
    ...
    setActiveType(type: TKContentPermutationTypeViewModel, updateUrl: boolean = true): void {
    ...
    permutationClasses(permutation: TKContentPermutationChoiceViewModel): any {
        let classes = {};
    ...
    contentClasses(content: TKPermutatedContentItemViewModel): any {
        let classes = {};
    ...
    onPermutationSelected(permutation: TKContentPermutationChoiceViewModel): void {
    ...
    matchesFilter(item: TKContentPermutationChoiceViewModel): boolean {
    ...
    get filteredPermutations(): Array<TKContentPermutationChoiceViewModel> {

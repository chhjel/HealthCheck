...
export default class ComparisonPageComponent extends Vue {
    ...
    instanceSearchResults: Array<TKComparisonInstanceSelection> = [];

    contentTypeDefinitions: Array<TKComparisonTypeDefinition> = [];
    ...
    onContentTypesRetrieved(data: Array<TKComparisonTypeDefinition>): void {
    ...
    onFilteredContentInstancesRetrieved(data: Array<TKComparisonInstanceSelection>): void {
        this.instanceSearchResults = data;
        this.hasSearchedForInstances = true;
    }

    onInstanceResultSelected(instance: TKComparisonInstanceSelection): void {
    ...
    onExecuteDiffCompleted(data: TKComparisonMultiDifferOutput): void {
        this.outputData = [];

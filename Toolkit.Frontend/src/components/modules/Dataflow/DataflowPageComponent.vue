...
import { TKDataflowUnifiedSearchResultItem } from "@generated/Models/Core/TKDataflowUnifiedSearchResultItem";
import { TKDataflowUnifiedSearchStreamResult } from "@generated/Models/Core/TKDataflowUnifiedSearchStreamResult";
...
interface SearchResultCachePerSearch {
   [key: string]: TKDataflowUnifiedSearchResult;
}
...
export default class DataflowPageComponent extends Vue {
    ...
    searchResult: TKDataflowUnifiedSearchResult | null = null;
    selectedSearchResult: TKDataflowUnifiedSearchResultItem | null = null;
    ...
    get searchUngroupedResultStreams(): Array<TKDataflowUnifiedSearchStreamResult> {
    ...
    performSearch(): void {
        const payload: TKDataFlowUnifiedSearchRequest = {
    ...
    onSearchResultRetrieved(data: TKDataflowUnifiedSearchResult): void {
    ...
    onSearchResultClicked(entry: TKDataflowUnifiedSearchResultItem): void {
    ...
    itemIsFirstOfTypeInGroup(entry: TKDataflowUnifiedSearchResultItem, group: KeyValuePair<string, Array<TKDataflowUnifiedSearchResultItem>>): boolean
    {
    ...
    getUngroupedEntriesFor(streamResult: TKDataflowUnifiedSearchStreamResult): Array<TKDataflowUnifiedSearchResultItem> {
        return streamResult.Entries.filter(x => !x.GroupByKey);
    }

    get groupedEntries(): Array<TKDataflowUnifiedSearchResultItem> {
        if (!this.searchResult) return [];

        let results: Array<TKDataflowUnifiedSearchResultItem> = [];
    ...
    get groupedEntryGroups(): Array<KeyValuePair<string, Array<TKDataflowUnifiedSearchResultItem>>> {

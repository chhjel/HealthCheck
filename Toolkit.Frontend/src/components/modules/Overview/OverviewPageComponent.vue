...
import { TKSiteEventsModuleFrontendOptionsModel } from "@generated/Models/Core/TKSiteEventsModuleFrontendOptionsModel";
import { StoreUtil } from "@util/StoreUtil";
import InputComponent from "@components/Common/Basic/InputComponent.vue";
import { TKSiteEventsModuleCalendarMode } from "@generated/Enums/Core/TKSiteEventsModuleCalendarMode";
...
export default class OverviewPageComponent extends Vue {
    ...
    @Prop({ required: true })
    options!: ModuleOptions<TKSiteEventsModuleFrontendOptionsModel>;
    ...
    translateCalendarMode(mode: TKSiteEventsModuleCalendarMode | null | undefined): string {
        if (mode == TKSiteEventsModuleCalendarMode.Month) return 'dayGridMonth';
        else if (mode == TKSiteEventsModuleCalendarMode.Week) return 'timeGridWeek';
        else if (mode == TKSiteEventsModuleCalendarMode.Day) return 'timeGridDay';
        else if (mode == TKSiteEventsModuleCalendarMode.List) return 'listWeek';
        else return '';
    }

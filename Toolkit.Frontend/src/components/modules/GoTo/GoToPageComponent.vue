...
export default class ComparisonPageComponent extends Vue {
    ...
    resolverDefinitions: Array<TKGoToResolverDefinition> = [];

    selectedResolverIds: Array<string> = [];
    query: string = '';
    results: Array<TKGoToResolvedDataWithResolverId> = [];
    ...
    onResolversRetrieved(data: Array<TKGoToResolverDefinition>): void {
    ...
    onGotoResultRetrieved(data: Array<TKGoToResolvedDataWithResolverId>): void {
        this.results = data;
    ...
    resultHeaderClasses(result: TKGoToResolvedDataWithResolverId): any {
        let classes = {};

...
import { TKDataExportStreamViewModel } from "@generated/Models/Module/DataExport/TKDataExportStreamViewModel";
...
import { TKDataExportStreamItemDefinitionViewModel } from "@generated/Models/Module/DataExport/TKDataExportStreamItemDefinitionViewModel";
...
import { TKDataExportExporterViewModel } from "@generated/Models/Module/DataExport/TKDataExportExporterViewModel";
import { TKDataExportValueFormatterConfig } from "@generated/Models/Module/DataExport/TKDataExportValueFormatterConfig";
import { TKDataExportValueFormatterViewModel } from "@generated/Models/Module/DataExport/TKDataExportValueFormatterViewModel";
import StringUtils from "@util/StringUtils";
import { StoreUtil } from "@util/StoreUtil";
import { TKDataExportStreamItemDefinitionMemberViewModel } from "@generated/Models/Module/DataExport/TKDataExportStreamItemDefinitionMemberViewModel";
...
export default class DataExportPageComponent extends Vue {
    ...
    streamDefinitions: TKGetDataExportStreamDefinitionsViewModel | null = null;
    exporters: Array<TKDataExportExporterViewModel> = [];
    selectedStream: TKDataExportStreamViewModel | null = null;
    ...
    itemDefinition: TKDataExportStreamItemDefinitionViewModel = { StreamId: '', Name: '', Members: [] };
    ...
    presets: Array<TKDataExportStreamQueryPresetViewModel> = [];
    presetToDelete: TKDataExportStreamQueryPresetViewModel | null = null;
    ...
    formattersInDialog: Array<TKDataExportValueFormatterViewModel> = [];
    ...
    get selectedFormatter(): TKDataExportValueFormatterViewModel | null {
    ...
    get formattersInDialogChoices(): Array<TKDataExportValueFormatterViewModel>
    {
        let items: Array<TKDataExportValueFormatterViewModel> = [
            {
                Id: <any>null,
                Name: 'No formatting',
                Description: '',
 ...
 Values in the dropdown or selected values can be copied to text by holding ctrl and clicking them.`;
    ...
    onStreamDefinitionsRetrieved(data: TKGetDataExportStreamDefinitionsViewModel | null): void {
    ...
    setActiveStream(stream: TKDataExportStreamViewModel | null, updateUrl: boolean = true): void {
        if (this.isLoading) {
            return;
        }
    ...
    applyPreset(preset: TKDataExportStreamQueryPresetViewModel): void {
        this.items = [];
        this.totalResultCount = 0;
    ...
    savePreset(name: string, existingPreset: TKDataExportStreamQueryPresetViewModel | null = null): void {
    ...
    getFormattersForHeader(header: string): Array<TKDataExportValueFormatterViewModel> {
        ...
        return member.FormatterIds
            ...
            .filter(x => x != null) as Array<TKDataExportValueFormatterViewModel>;
        // return this.getFormattersForType(member.TypeName);
    }

    getFormattersForType(type: string): Array<TKDataExportValueFormatterViewModel> {
    ...
    createQueryPayload(exporterId: string | null = null): TKDataExportQueryRequest {
    ...
    onStreamItemsLoaded(data: TKDataExportQueryResponseViewModel): void {
    ...
    exportParameterItemClasses(parameter: TKBackendInputConfig): any {
        let classes: any = {
            'full-width': parameter.UIHints.includes(TKUIHint.FullWidth)
        };
        return classes;
    }
    ...
    onDeletePresetClicked(target: TKDataExportStreamQueryPresetViewModel): void {

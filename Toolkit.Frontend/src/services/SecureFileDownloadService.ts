import { TKSecureFileDownloadFileDetails } from './../generated/Models/Core/TKSecureFileDownloadFileDetails';
import TKServiceBase, { FetchStatus, FetchStatusWithProgress, ServiceFetchCallbacks } from "./abstractions/TKServiceBase";
...
export default class SecureFileDownloadService extends TKServiceBase
{
    ...
    public GetStorageFileIdOptions(
        storageId: string,
        statusObject: FetchStatus | null = null,
        callbacks: ServiceFetchCallbacks<Array<TKSecureFileDownloadFileDetails>> | null = null
    ): void {

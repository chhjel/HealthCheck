...
namespace QoDL.Toolkit.Core.Abstractions.Modules
{
    ...
    /// </summary>
    public class ToolkitModuleContext
    {
        /// <summary>
        ...
        /// </summary>
        public ToolkitModuleRequestData Request { get; set; }
        ...
        /// </summary>
        public TKAuditLogModuleOptions.StripSensitiveDataDelegate SensitiveDataStripper { get; set; }
        ...
        /// </summary>
        public ReadOnlyCollection<ToolkitLoadedModule> LoadedModules { get; set; }

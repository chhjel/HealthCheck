...
namespace QoDL.Toolkit.Core.Util
{
    ...
    /// </summary>
    public class TKSimpleDataStoreWithId<TItem, TId> : TKSimpleDataStore<TItem>, IDataStoreWithEntryId<TItem>
    {
        ...
        public TKSimpleDataStoreWithId(string filepath,

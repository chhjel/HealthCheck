...
namespace QoDL.Toolkit.Core.Util.Storage
{
    ...
    /// </summary>
    public abstract class TKSingleBufferedBlobStorageBase<TData, TItem> : TKSingleBlobStorageBase<TData>
        where TData : new()
    {
        /// <summary>
        ...
        /// </summary>
        protected readonly TKDelayedBufferQueue<BufferQueueItem> BufferQueue;
        ...
        /// </summary>
        protected TKSingleBufferedBlobStorageBase(ITKCache cache)
            : base(cache)
        {
            BufferQueue = new TKDelayedBufferQueue<BufferQueueItem>(OnBufferCallback, TimeSpan.FromSeconds(10), 100);
        }

        /// <summary>
        /// Max buffer size.
        /// </summary>
        public TKSingleBufferedBlobStorageBase<TData, TItem> SetMaxBufferSize(int maxCount)
        {
        ...
        /// Max duration to buffer data in memory for before writing to blob storage.
        /// </summary>
        public TKSingleBufferedBlobStorageBase<TData, TItem> SetBlobUpdateBufferDuration(TimeSpan duration)
        {

...
/// </summary>
public abstract class TKSingleBufferedMultiListBlobStorageBase<TData, TItem, TId>
    : TKSingleBufferedBlobStorageBase<TData, TItem>
    where TData : TKSingleBufferedMultiListBlobStorageBase<TData, TItem, TId>.IBufferedBlobMultiListStorageData, new()
{
    /// <summary>
    ...
    /// </summary>
    protected TKSingleBufferedMultiListBlobStorageBase(ITKCache cache)
        : base(cache)
    {
    }
    ...
    /// Optionally limit the max number of different lists.
    /// </summary>
    public TKSingleBufferedMultiListBlobStorageBase<TData, TItem, TId> SetMaxListCount(int? maxListCount)
    {
    ...
    /// Optionally limit the max number of latest items to store per list.
    /// </summary>
    public TKSingleBufferedMultiListBlobStorageBase<TData, TItem, TId> SetMaxItemCountPerList(int? maxItemCountPerList)
    {

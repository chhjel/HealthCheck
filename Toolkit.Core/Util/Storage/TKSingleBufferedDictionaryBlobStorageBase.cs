...
/// </summary>
public abstract class TKSingleBufferedDictionaryBlobStorageBase<TData, TItem, TId>
    : TKSingleBlobStorageBase<TData>
    where TData : TKSingleBufferedDictionaryBlobStorageBase<TData, TItem, TId>.IBufferedBlobDictionaryStorageData, new()
{
    /// <summary>
    ...
    /// </summary>
    protected readonly TKDelayedBufferDictionary<TId, BufferQueueItem> BufferQueue;
    ...
    /// </summary>
    protected TKSingleBufferedDictionaryBlobStorageBase(ITKCache cache)
        : base(cache)
    {
        BufferQueue = new TKDelayedBufferDictionary<TId, BufferQueueItem>(x => x.Id, OnBufferCallback, TimeSpan.FromSeconds(10), 100);
    }
    ...
    /// <para>The first n items will be kept.</para>
    /// </summary>
    public TKSingleBufferedDictionaryBlobStorageBase<TData, TItem, TId> SetMaxItemCount(int? maxCount)
    {
    ...
    /// </summary>
    public TKSingleBufferedDictionaryBlobStorageBase<TData, TItem, TId> SetMaxItemAge(TimeSpan? maxAge)
    {
        MaxItemAge = maxAge;
        return this;
    }

...
/// </summary>
public class TKDelayedBufferQueue<T>
{
    /// <summary>
    ...
    public TKDelayedBufferQueue(Action<Queue<T>> callback = null, TimeSpan? delay = null, int? queueSizeLimit = null)
    {
        Callback = callback;
        if (delay != null)
        {

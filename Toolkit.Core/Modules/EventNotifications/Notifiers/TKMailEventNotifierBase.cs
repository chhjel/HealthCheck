...
/// Sends mail.
/// </summary>
public abstract class TKMailEventNotifierBase : IEventNotifier
{
    ...
    /// <summary>
    /// Options for <see cref="TKMailEventNotifierBase"/>.
    /// </summary>
    public class MailEventNotifierOptions
    {
        ...
        /// Body of the mail.
        /// </summary>
        [EventNotifierOption(Description = "Contents of the e-mail.", UIHints = TKUIHint.TextArea)]

...
/// </summary>
public class TKLogViewerModule : ToolkitModuleBase<TKLogViewerModule.AccessOption>
{
    private TKLogViewerModuleOptions Options { get; }
    private static List<LogSearchInProgress> SearchesInProgress { get; set; } = new List<LogSearchInProgress>();

    /// <summary>
    /// Module for viewing logfiles.
    /// </summary>
    public TKLogViewerModule(TKLogViewerModuleOptions options)
    {
        Options = options;
    }
    ...
    /// </summary>
    [ToolkitModuleMethod]
    public async Task<LogSearchResult> SearchLogs(ToolkitModuleContext context, LogSearchFilter filter)
    {
    ...
    /// </summary>
    [ToolkitModuleMethod]
    public bool CancelLogSearch(ToolkitModuleContext context, string searchId)
    {
    ...
    /// </summary>
    [ToolkitModuleMethod]
    public int CancelAllLogSearches(ToolkitModuleContext context)
    {

...
public class UrlFileStorage : ISecureFileDownloadFileStorage
{
    ...
    /// Returns null.
    /// </summary>
    public IEnumerable<TKSecureFileDownloadFileDetails> GetFileIdOptions() => Enumerable.Empty<TKSecureFileDownloadFileDetails>();

    /// <summary>
    /// Not supported for this implementation.
    /// </summary>
    public Task<TKSecureFileDownloadUploadResult> UploadFileAsync(Stream stream) => Task.FromResult(new TKSecureFileDownloadUploadResult
    {
        Success = false,
        FileId = null,

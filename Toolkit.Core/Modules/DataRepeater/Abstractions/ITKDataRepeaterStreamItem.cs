...
{
    /// <summary>
    /// An item that can be stored in a <see cref="ITKDataRepeaterStream"/>.
    /// </summary>
    public interface ITKDataRepeaterStreamItem
    {
        /// <summary>
        ...
        /// </summary>
        TKDataRepeaterStreamItemStatus? ForcedStatus { get; set; }
        ...
        /// </summary>
        List<TKDataRepeaterSimpleLogEntry> Log { get; set; }

...
/// <summary>
/// Extensions for <see cref="ITKDataRepeaterStream"/>
/// </summary>
public static class TKDataRepeaterStreamExtensions
{
    /// <summary>
    /// Get item matching the given item id.
    /// </summary>
    public static async Task<ITKDataRepeaterStreamItem> GetItemByItemIdAsync(this ITKDataRepeaterStream stream, string itemId)
        => await stream.Storage.GetItemByItemIdAsync(itemId).ConfigureAwait(false);

    /// <summary>
    /// Delete item matching the given item id.
    /// </summary>
    public static async Task<bool> DeleteItemAsync(this ITKDataRepeaterStream stream, string itemId)
    {
    ...
    /// </summary>
    public static async Task<bool> RemoveAllItemTagsAsync(this ITKDataRepeaterStream stream, string itemId)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    /// </summary>
    public static async Task<bool> RemoveItemTagAsync(this ITKDataRepeaterStream stream, string itemId, string tag)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    /// </summary>
    public static async Task<bool> AddItemTagAsync(this ITKDataRepeaterStream stream, string itemId, string tag)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    /// </summary>
    public static async Task<bool> AddItemTagsAsync(this ITKDataRepeaterStream stream, string itemId, params string[] tags)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    /// </summary>
    public static async Task<bool> RemoveItemTagsAsync(this ITKDataRepeaterStream stream, string itemId, params string[] tags)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    public static async Task<bool> SetTagsAsync(this ITKDataRepeaterStream stream, string itemId, Dictionary<string, bool> tags, bool removeOtherTags = false)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    /// </summary>
    public static async Task<bool> SetAllowItemRetryAsync(this ITKDataRepeaterStream stream, string itemId, bool allow)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    /// </summary>
    public static async Task<bool> SetExpirationTimeAsync(this ITKDataRepeaterStream stream, string itemId, DateTimeOffset? time)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    public static async Task<bool> SetForcedItemStatusAsync(this ITKDataRepeaterStream stream, string itemId, TKDataRepeaterStreamItemStatus? status,
        ...
        string error = null, Exception exception = null)
    {
        ...
        if (exception != null)
        {
            error += $"\n\n{TKExceptionUtils.GetFullExceptionDetails(exception)}";
        }
    ...
    public static async Task<bool> AddItemLogMessageAsync(this ITKDataRepeaterStream stream, string itemId, string logMessage)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;
    ...
    public static async Task<bool> SetItemErrorAsync<TStream>(this ITKDataRepeaterStream stream, string itemId, string error, Exception exception = null)
    {
        var item = await stream.GetItemByItemIdAsync(itemId).ConfigureAwait(false);
        if (item == null) return false;

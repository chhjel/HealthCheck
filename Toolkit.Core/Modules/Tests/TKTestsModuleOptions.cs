...
{
    /// <summary>
    /// Options for <see cref="TKTestsModule"/>.
    /// </summary>
    public class TKTestsModuleOptions
    {
        /// <summary>
        ...
        /// </summary>
        public Func<Type, TKTestsJsonTemplateResult> JsonInputTemplateFactory { get; set; }
        ...
        /// <para>Should handle the input and return a <see cref="ToolkitFileDownloadResult"/> with the matching file to download, or null if no file should be downloaded.</para>
        ...
        public delegate ToolkitFileDownloadResult FileDownloadHandlerDelegate(string type, string id);
    }
}

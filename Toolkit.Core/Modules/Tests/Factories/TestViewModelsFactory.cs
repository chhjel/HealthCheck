...
using QoDL.Toolkit.Core.Modules.Tests.Utils;
...
namespace QoDL.Toolkit.Core.Modules.Tests.Factories
{
    /// <summary>
    ...
    public class TestViewModelsFactory
    {
        ...
        /// </summary>
        public List<TestSetViewModel> CreateViewModel(IEnumerable<TestClassDefinition> testClassDefinitions, TKTestsModuleOptions options, List<string> userCategoryAccess)
        ...
        /// </summary>
        public TestSetViewModel CreateViewModel(TestClassDefinition testClassDefinition, TKTestsModuleOptions options, List<string> userCategoryAccess)
        {
        ...
        /// </summary>
        public IEnumerable<TestViewModel> CreateViewModels(TestDefinition testDefinition, TKTestsModuleOptions options, List<string> userCategoryAccess)
        {
        ...
        private TestViewModel CreateViewModel(TestDefinition testDefinition, TKTestsModuleOptions options, List<string> userCategoryAccess)
        {
        ...
        /// </summary>
        public TestParameterViewModel CreateViewModel(TestParameter testParameter, TKTestsModuleOptions options)
        {
            var stringConverter = new TKStringConverter();
            var paramType = testParameter.ParameterType;
            string type = TKCustomPropertyAttribute.CreateParameterTypeName(paramType);
            ...
            var vm = new TestParameterViewModel()
            {
                ...
                TextPattern = TKBackendInputConfig.EnsureJsRegexIsWrappedIfNotEmpty(testParameter?.TextPattern),
        ...
        /// </summary>
        public List<TestParameterTemplateViewModel> CreateParameterTemplatesViewModel(List<TestClassDefinition> testDefinitions, TKTestsModuleOptions options)
        {
            ...
            return relevantParameters.Select(x =>
            {
                ...
                {
                    Type = TKCustomPropertyAttribute.CreateParameterTypeName(x.ParameterType),
                    Template = template ?? "{\n}"
                };
            }).ToList();
        }

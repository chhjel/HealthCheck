...
using QoDL.Toolkit.Utility.Reflection.Logging;
using System;
...
public class ClassProxyTests
{
    ...
    public static ProxyRuntimeTestConfig ProxyTest()
    {
        ...
        return new ProxyRuntimeTestConfig(typeof(SomeService))
            ...
            .SetCustomContext(
                contextFactory: () => new { MemoryLogger = TKLogTypeBuilder.CreateMemoryLoggerFor<ISomeLogger>(forwardTo: new SomeLogger()) },

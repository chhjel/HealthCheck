...
namespace QoDL.Toolkit.WebUI.Services
{
    ...
    {
        private TKSimpleDataStoreWithId<SiteEvent, Guid> Store { get; set; }
        ...
        {
            Store = new TKSimpleDataStoreWithId<SiteEvent, Guid>(
                filepath,
            ...
            if (maxEventAge != null)
            {
                ...
                Store.RetentionOptions = new TKStorageRetentionOptions<SiteEvent>(
                    (item) => item.Timestamp,

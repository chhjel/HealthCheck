...
namespace HealthCheck.Core.Modules.Comparison.Abstractions
{
    ...
    /// </summary>
    public interface IHCComparisonTypeHandler
    {
        /// <summary>
        /// The content type that will be returned from <see cref="GetInstanceWithIdAsync"/>.
        /// <para>Is passed to <see cref="IHCComparisonDiffer.CanHandle"/> to see if it can handle the type.</para>
        /// </summary>
        ...
        /// </summary>
        Task<List<HCComparisonInstanceSelection>> GetFilteredOptionsAsync(HCComparisonTypeFilter filter);

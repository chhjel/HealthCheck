...
namespace HealthCheck.Core.Modules.DataRepeater.Abstractions
{
    ...
    /// </summary>
    public abstract class HCDataRepeaterStreamItemBatchActionBase<TParameters> : IHCDataRepeaterStreamItemBatchAction
        where TParameters : class, new()
    {
        ...
        /// <inheritdoc />
        public async Task<HCDataRepeaterStreamItemBatchActionResult> ExecuteBatchActionAsync(IHCDataRepeaterStreamItem item, object parameters, HCDataRepeaterStreamBatchActionResult batchResult)
        ...
        protected abstract Task<HCDataRepeaterStreamItemBatchActionResult> PerformBatchActionAsync(IHCDataRepeaterStreamItem item, TParameters parameters, HCDataRepeaterStreamBatchActionResult batchResult);
    }
}

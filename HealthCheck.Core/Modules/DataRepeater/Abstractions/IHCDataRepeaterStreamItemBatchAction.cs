...
namespace HealthCheck.Core.Modules.DataRepeater.Abstractions
{
    ...
    /// </summary>
    public interface IHCDataRepeaterStreamItemBatchAction
    {
        /// <summary>
        ...
        Task<HCDataRepeaterStreamItemBatchActionResult> ExecuteBatchActionAsync(IHCDataRepeaterStreamItem item, object parameters, HCDataRepeaterStreamBatchActionResult batchResult);
    }
}

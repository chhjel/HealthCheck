...
namespace HealthCheck.Core.Util.Collections
{
    ...
    /// </summary>
    public class HCDelayedBufferQueue<T>
    {
        /// <summary>
        ...
        public HCDelayedBufferQueue(Action<Queue<T>> callback = null, TimeSpan? delay = null, int? queueSizeLimit = null)
        {
            Callback = callback;
            if (delay != null)
            {

...
namespace HealthCheck.Core.Util
{
    ...
    /// <para>If you need item ids use <see cref="HCSimpleDataStoreWithId{TItem, TId}"/> instead.</para>
    /// </summary>
    public class HCSimpleDataStore<TItem> : IDataStore<TItem>
    {
        /// <summary>
        /// Options for automatic storage cleanup.
        /// </summary>
        public HCStorageRetentionOptions<TItem> RetentionOptions { get; set; }
        ...
        public HCSimpleDataStore(string filepath,

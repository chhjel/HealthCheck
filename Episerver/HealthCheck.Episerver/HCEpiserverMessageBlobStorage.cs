...
namespace HealthCheck.Episerver
{
    ...
    /// </summary>
    public class HCEpiserverMessageBlobStorage
        : HCEpiserverSingleBufferedBlobStorageBase<HCEpiserverMessageBlobStorage.HCMessagesBlobData, KeyValuePair<string, IHCMessageItem>>, IHCMessageStorage
    {
        /// <inheritdoc />
        ...
        /// Stores messages in blob storage.
        /// </summary>
        public HCEpiserverMessageBlobStorage(IBlobFactory blobFactory, IMemoryCache cache)
        ...
        /// </summary>
        public class HCMessagesBlobData : IBufferedBlobStorageData
        {
            /// <inheritdoc />

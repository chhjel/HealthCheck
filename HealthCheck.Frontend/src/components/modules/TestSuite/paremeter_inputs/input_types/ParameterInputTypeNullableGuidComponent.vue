<!-- src/components/modules/TestSuite/paremeter_inputs/input_types/ParameterInputTypeNullableGuidComponent.vue -->
<template>
    <div>
        <v-layout>
...
export default class ParameterInputTypeNullableGuidComponent extends Vue {
    @Prop({ required: true })
    ...
    get placeholderText(): string {
        ...
        else if (this.parameter.Value.length == 0) return "00000000-0000-0000-0000-000000000000"
        else return "";
    }
}
</script>

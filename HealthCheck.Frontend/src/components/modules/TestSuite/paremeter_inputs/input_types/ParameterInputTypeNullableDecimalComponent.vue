<!-- src/components/modules/TestSuite/paremeter_inputs/input_types/ParameterInputTypeNullableDecimalComponent.vue -->
<template>
    <div>
        <v-text-field
            type="number"
...
export default class ParameterInputTypeNullableDecimalComponent extends Vue {
    @Prop({ required: true })

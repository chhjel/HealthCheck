<!-- src/components/modules/TestSuite/paremeter_inputs/input_types/ParameterInputTypeNullableDateTimeComponent.vue -->
<template>
    <div>
        <v-text-field
            class="pt-0"
...
export default class ParameterInputTypeNullableDateTimeComponent extends Vue {
    @Prop({ required: true })

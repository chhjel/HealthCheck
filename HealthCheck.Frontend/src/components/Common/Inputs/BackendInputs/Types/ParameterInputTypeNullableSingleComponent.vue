<!-- src/components/modules/TestSuite/paremeter_inputs/input_types/ParameterInputTypeNullableSingleComponent.vue -->
<template>
    <div>
        <v-text-field
            type="number"
...
export default class ParameterInputTypeNullableSingleComponent extends Vue {
    @Prop({ required: true })

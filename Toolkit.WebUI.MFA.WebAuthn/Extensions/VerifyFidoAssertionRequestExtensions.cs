...
/// <summary>
/// Extensions for <see cref="TKVerifyWebAuthnAssertionModel"/>.
/// </summary>
public static class VerifyFidoAssertionRequestExtensions
{
    ...
    /// </summary>
    public static AuthenticatorAssertionRawResponse ToAuthenticatorAssertionRawResponse(this TKVerifyWebAuthnAssertionModel model)
    {
        if (model == null)
        {

...
using QoDL.Toolkit.WebUI.Tests.Helpers;
using QoDL.Toolkit.WebUI.Tests.ModuleSystem.Helpers;
...
namespace QoDL.Toolkit.WebUI.Tests.ModuleSystem
{
    public class InvokeModuleMethodFromHelperTests
    {
        ...
        private ToolkitControllerHelper<AccessRoles> CreateHelper(AccessRoles roles, Action<AccessConfig<AccessRoles>> accessConfig)
        {
            var helper = new ToolkitControllerHelper<AccessRoles>(null, null);

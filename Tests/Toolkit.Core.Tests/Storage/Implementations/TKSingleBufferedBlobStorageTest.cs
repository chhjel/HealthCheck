...
public class TKSingleBufferedBlobStorageTest : TKSingleBufferedBlobStorageBase<TKSingleBufferedBlobStorageTest.TestData, TestItem>
{
    ...
    protected override string CacheKey => "TKSingleBufferedBlobStorageTest";

    public TKSingleBufferedBlobStorageTest(ITKCache cache, ITestOutputHelper output) : base(cache)
    {
        Output = output;
    }

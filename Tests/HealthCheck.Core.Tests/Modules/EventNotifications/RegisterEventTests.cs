...
using static HealthCheck.Core.Tests.Modules.EventNotifications.EventNotificationsTestHelpers;

namespace HealthCheck.Core.Tests.Modules.EventNotifications
{

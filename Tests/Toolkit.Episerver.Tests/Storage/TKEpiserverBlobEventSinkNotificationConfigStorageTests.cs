...
{
    public class TKEpiserverBlobEventSinkNotificationConfigStorageTests
    {
        [Fact]
        ...
        private TKEpiserverBlobEventSinkNotificationConfigStorage CreateStorage(Func<MockBlob> blobFactory = null, string blobJson = null)
        {
            ...
            return new TKEpiserverBlobEventSinkNotificationConfigStorage(factoryMock.Object, cache);
        }
    }
}

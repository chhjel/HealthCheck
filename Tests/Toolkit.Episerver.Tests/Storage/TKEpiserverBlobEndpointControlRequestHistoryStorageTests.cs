using QoDL.Toolkit.Episerver.EndpointControl;
...
{
    public class TKEpiserverBlobEndpointControlRequestHistoryStorageTests
    {
        [Fact]
        ...
        private TKEpiserverBlobEndpointControlRequestHistoryStorage CreateStorage(Func<MockBlob> blobFactory = null, string blobJson = null)
        {
            ...
            return new TKEpiserverBlobEndpointControlRequestHistoryStorage(factoryMock.Object, cache);
        }
    }
}
